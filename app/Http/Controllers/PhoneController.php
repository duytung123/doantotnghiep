...
class PhoneController extends Controller
{
	...
	{
		$data['product1']=Product::where('prod_featured',1)->where('prod_cate',1)->orderBy('prod_id','desc')->take(1)->get();


		$data1['product']=Product::where('prod_featured',3)->where('prod_cate',1)->orderBy('prod_id','desc')->take(1)->get();
        // san pham phone sale1s

		$data1['product2']=Product::where('prod_featured',0)->where('prod_cate',1)->orderBy('prod_id','desc')->take(3)->get();

		$data['product3']=Product::where('prod_featured',4)->where('prod_cate',1)->orderBy('prod_id','desc')->take(0)->get();

		$data1['product4']=Product::where('prod_featured',2)->where('prod_cate',1)->orderBy('prod_id','desc')->take(3)->get();
