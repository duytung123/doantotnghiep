...
{
  $data['product']=Product::where('prod_price','<',10000000)->where('prod_cate',3)->orderBy('prod_id','desc')->paginate(4);
  return view('fontend.Tablet.ListPrice',$data);
}

public function price2()
{
  $data['product']=Product::whereBetween('prod_price',[10000000,15000000])->where('prod_cate',3)->orderBy('prod_id','desc')->paginate(4);
  return view('fontend.Tablet.ListPrice',$data);
}

public function price3()
{
  $data['product']=Product::whereBetween('prod_price',[15000000,20000000])->where('prod_cate',3)->orderBy('prod_id','desc')->paginate(4);
  return view('fontend.Tablet.ListPrice',$data);
}

public function price4()
{
  $data['product']=Product::whereBetween('prod_price',[20000000,25000000])->where('prod_cate',3)->orderBy('prod_id','desc')->paginate(4);
  return view('fontend.Tablet.ListPrice',$data);
}

public function price5()
{
  $data['product']=Product::where('prod_price','>',25000000)->where('prod_cate',3)->orderBy('prod_id','desc')->paginate(4);
  return view('fontend.Tablet.ListPrice',$data);
}
