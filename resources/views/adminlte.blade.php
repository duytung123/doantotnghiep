...
<html>
   ...
   <body class="hold-transition sidebar-mini layout-fixed">
         ...
         <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
               ...
               <li class="nav-item has-treeview">
                  ...
                  <ul class="nav nav-treeview">
                     <li class="nav-item">
                        <a href="cateallproduct" class="nav-link">
                           <i class="far fa-circle nav-icon"></i>
      ...
      <script type="text/javascript">
         $(document).ready(function(){
           $('#btn_dashboard_filter').click(function(){
             ...
             var fromday = $("#datepicker").val();
             var today = $("#datepicker2").val();
             //alert(fromday);
             $.ajax({
               url:"{{url('/filetr')}}",
               method:"POST",
               dataType:"JSON",
               data:{fromday:fromday,today:today,_token:_token},
      ...
      <script type="text/javascript">
         ...
         lineColors:['red','blue','black','yellow'],
