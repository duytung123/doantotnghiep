...
<script>
	...
	<div class="commenttong">
		...
		<div class="bigbig invisible">
			...
			<div>
				<textarea id="r_content" name="" cols="50" rows="3" placeholder="Nhập đánh giá về sản phẩm"></textarea>
			...
			<div class="email">
				<input id="r_email" required placeholder="email" type="email">
			</div>
			<div class="phone">
				<input id="r_phone" required placeholder="số điện thoại" type="number">
			</div>
		...
		<div> 
			...
			@foreach($phukien as $product)
					...
					<a href=""><img src="{{asset('../storage/app/avatar/'.$product->prod_img)}}" alt=""></a>
